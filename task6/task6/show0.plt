...
set terminal GNUTERM size 1000,800
set encoding utf8
#==============================================================================
# SETUP COMMANDS
#==============================================================================
...
#==============================================================================
plot \
    'plot0.dat' index 0 title 'Euler' with lines linestyle 1 linewidth 2, \
    'plot0.dat' index 1 title 'RK2' with lines linestyle 2 linewidth 2, \
    'plot0.dat' index 2 title 'RK4' with lines linestyle 3 linewidth 2
