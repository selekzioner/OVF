...
set terminal GNUTERM size 1000,700
set encoding utf8
#==============================================================================
# SETUP COMMANDS
#==============================================================================
...
#==============================================================================
plot \
    'plot0.dat' index 0 title 'Trapezioidal' with linespoints linestyle 1 linewidth 10, \
    'plot0.dat' index 1 title 'Simpson' with linespoints linestyle 2 linewidth 5
